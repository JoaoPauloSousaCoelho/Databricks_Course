...
v_result = dbutils.notebook.run("1_ingest_circuit_files", 0,{"p_data_source": "Ergast API","p_file_date": "2021-04-18"})

# COMMAND ----------

v_result = dbutils.notebook.run("2_ingest_race_files", 0,{"p_data_source": "Ergast API","p_file_date": "2021-04-18"})
