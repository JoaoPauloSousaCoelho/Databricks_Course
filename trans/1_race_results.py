...
final_df = race_results_df.select("race_id", "race_year", "race_name", "race_date", "circuit_location",
                                 ...
                                 "grid", "fastest_lap", "team", "race_time", "points", "position", "result_file_date")\
...
merge_delta_data(final_df, "f1_presentation", presentation_folder_path, "race_results", merge_condition, "race_id")
